import 'package:accidenyally/connectivity.dart';
import 'package:accidenyally/login.dart';
import 'package:accidenyally/main.dart';
import 'package:accidenyally/no_internet.dart';
...
/* class Paggessui extends StatefulWidget {
  @override
  _PaggessuiState createState() => _PaggessuiState();
}

class _PaggessuiState extends State<Paggessui> {
  @override
  Widget build(BuildContext context) {
    return Consumer<ConnectivityProvider>(
      builder: (context, model, child) {
        if (model.isOnline != null) {
          return model.isOnline ? Lgn() : Nointernert();
        }
