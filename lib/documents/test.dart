import 'package:accidenyally/documents/image_reader.dart';
...
Widget getdecors(BuildContext context, String type, double sheight,
    double swidth, String text, String fichier) {
  Color colorval;
  Color stcolor;
  Color encolor;
  Image image;
